            ...
            <div className="col-md-12">
              <div className="category-carousel swiper">
                <div className="swiper-wrapper">
                  ...
                  >
                    <img
                      src="/public/images/icon-vegetables-broccoli.png"
                  ...
                  >
                    <img
                      src="/public/images/icon-bread-baguette.png"
                      alt="Category Thumbnail"
                    />
                  ...
                  >
                    <img
                      src="/public/images/icon-soft-drinks-bottle.png"
                      alt="Category Thumbnail"
                    />
                    <h3 className="category-title">Fruits & Veges</h3>
                  </a>
                  ...
                  >
                    <img
                      src="/public/images/icon-wine-glass-bottle.png"
                      alt="Category Thumbnail"
                    />
                    <h3 className="category-title">Fruits & Veges</h3>
                  </a>
                  ...
                  >
                    <img
                      src="/public/images/icon-animal-products-drumsticks.png"
                      alt="Category Thumbnail"
                    />
                    <h3 className="category-title">Fruits & Veges</h3>
                  </a>
                  ...
                  >
                    <img
                      src="/public/images/icon-bread-herb-flour.png"
                      alt="Category Thumbnail"
                    />
                    <h3 className="category-title">Fruits & Veges</h3>
                  </a>
